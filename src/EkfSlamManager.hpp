    ...
    class Manager {
      public:
        ...
        auto update(typename Vehicle::Meas vehicleMeas, const std::vector<typename Object::Meas> &objectMeasurements,
                    double dt) -> std::pair<typename Vehicle::State, std::vector<typename Object::State>> {
            this->dt = dt;
            ...
            ekf.update(z_vehicle, z_object, association::nearest_neighbor_association<Object::Meas::DIM, T>);
